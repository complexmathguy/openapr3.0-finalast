...
public class ProblemTest{
	...
	protected void jumpStart() throws Throwable {
		...
		problemId = ProblemBusinessDelegate.getProblemInstance()
		.createProblem( generateNewCommand() )
		.get();
	...
	protected void setUpQuerySubscriptions() throws Throwable {
		...
		try {            
			subscriber.problemSubscribe().updates().subscribe(
					  successValue -> {
						  LOGGER.info(successValue.toString());
						  try {
							  LOGGER.info("GetAll update received for Problem : " + successValue.getProblemId());
							  if (successValue.getProblemId().equals(problemId)) {
								  if (testingStep.equals("create")) {
									  ...
									  state( getAll().size() == sizeOfProblemList - 1 , "value not deleted from list");
									  LOGGER.info("**********************************************************");
			...
			subscriber.problemSubscribe( problemId ).updates().subscribe(
					  successValue -> {
						  LOGGER.info(successValue.toString());
						  try {
							  LOGGER.info("GetOne update received for Problem : " + successValue.getProblemId() + " in step " + testingStep);
							  testingStep = "delete";
	...
	protected void update() throws Throwable {
		...
		try {            
			...
			LOGGER.warning( unexpectedErrorMsg );
			LOGGER.warning( msg.toString() + " : primarykey = " + problemId + " : command -" +  command + " : " + e );
	...
	protected void delete() throws Throwable {
		...
		try{
			ProblemBusinessDelegate.getProblemInstance().delete( new DeleteProblemCommand( entity.getProblemId() ) ).get();
	...
	protected CreateProblemCommand generateNewCommand() {
        CreateProblemCommand command = new CreateProblemCommand( null,  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  0,  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16) );
