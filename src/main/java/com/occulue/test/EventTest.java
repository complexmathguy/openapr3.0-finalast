...
public class EventTest{
	...
	protected CreateEventCommand generateNewCommand() {
        CreateEventCommand command = new CreateEventCommand( null,   new Date(),   new Date(),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  0,  ObjectType.values()[0] );
	...
	protected UpdateEventCommand generateUpdateCommand() {
	        UpdateEventCommand command = new UpdateEventCommand( null,   new Date(),   new Date(),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  0,  null,  null,  new HashSet<>(),  new HashSet<>(),  new HashSet<>(),  ObjectType.values()[0],  null );
