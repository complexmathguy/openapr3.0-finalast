...
public class NotificationTest{
	...
	protected CreateNotificationCommand generateNewCommand() {
        CreateNotificationCommand command = new CreateNotificationCommand( null,  ObjectType.values()[0],  Operation.values()[0] );
	...
	protected UpdateNotificationCommand generateUpdateCommand() {
	        UpdateNotificationCommand command = new UpdateNotificationCommand( null,  null,  ObjectType.values()[0],  Operation.values()[0],  null );
