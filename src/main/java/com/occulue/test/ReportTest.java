...
public class ReportTest{
	...
	protected void jumpStart() throws Throwable {
		...
		reportId = ReportBusinessDelegate.getReportInstance()
	...
	protected void delete() throws Throwable {
		...
		try{
			ReportBusinessDelegate.getReportInstance().delete( new DeleteReportCommand( entity.getReportId() ) ).get();
	...
	protected CreateReportCommand generateNewCommand() {
        CreateReportCommand command = new CreateReportCommand( null,   new Date(),   new Date(),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  ObjectType.values()[0] );
	...
	protected UpdateReportCommand generateUpdateCommand() {
	        UpdateReportCommand command = new UpdateReportCommand( null,   new Date(),   new Date(),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  null,  null,  new HashSet<>(),  new HashSet<>(),  null,  ObjectType.values()[0],  null );
