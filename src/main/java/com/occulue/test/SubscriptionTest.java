...
public class SubscriptionTest{
	...
	protected CreateSubscriptionCommand generateNewCommand() {
        CreateSubscriptionCommand command = new CreateSubscriptionCommand( null,   new Date(),   new Date(),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  ObjectType.values()[0] );
	...
	protected UpdateSubscriptionCommand generateUpdateCommand() {
	        UpdateSubscriptionCommand command = new UpdateSubscriptionCommand( null,   new Date(),   new Date(),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  null,  new HashSet<>(),  null,  ObjectType.values()[0] );
