...
public class VenTest{
	...
	protected CreateVenCommand generateNewCommand() {
        CreateVenCommand command = new CreateVenCommand( null,   new Date(),   new Date(),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  ObjectType.values()[0] );
