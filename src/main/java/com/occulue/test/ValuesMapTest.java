...
public class ValuesMapTest{
	...
	protected void jumpStart() throws Throwable {
		...
		valuesMapId = ValuesMapBusinessDelegate.getValuesMapInstance()
	...
	protected void setUpQuerySubscriptions() throws Throwable {
		...
		try {            
			subscriber.valuesMapSubscribe().updates().subscribe(
					  successValue -> {
						  LOGGER.info(successValue.toString());
						  try {
							  LOGGER.info("GetAll update received for ValuesMap : " + successValue.getValuesMapId());
							  if (successValue.getValuesMapId().equals(valuesMapId)) {
								  if (testingStep.equals("create")) {
									  ...
									  state( getAll().size() == sizeOfValuesMapList - 1 , "value not deleted from list");
									  LOGGER.info("**********************************************************");
			...
			subscriber.valuesMapSubscribe( valuesMapId ).updates().subscribe(
					  successValue -> {
						  LOGGER.info(successValue.toString());
						  try {
							  LOGGER.info("GetOne update received for ValuesMap : " + successValue.getValuesMapId() + " in step " + testingStep);
							  testingStep = "delete";
	...
	protected void update() throws Throwable {
		...
		try {            
			...
			LOGGER.warning( unexpectedErrorMsg );
			LOGGER.warning( msg.toString() + " : primarykey = " + valuesMapId + " : command -" +  command + " : " + e );
	...
	protected void delete() throws Throwable {
		...
		try{
			ValuesMapBusinessDelegate.getValuesMapInstance().delete( new DeleteValuesMapCommand( entity.getValuesMapId() ) ).get();
	...
	protected CreateValuesMapCommand generateNewCommand() {
        CreateValuesMapCommand command = new CreateValuesMapCommand( null,  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16) );
	...
	protected UpdateValuesMapCommand generateUpdateCommand() {
	        UpdateValuesMapCommand command = new UpdateValuesMapCommand( null,  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16) );
