...
//		Assert.isNull( event.getEventId(), "CreateEventCommand identifier should be null" );
	...
	public void validate( AssignTargetsToEventCommand command ) throws Exception {
		...
		Assert.notNull( command.getEventId(), "AssignTargetsToEventCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTargetsToEventCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTargetsFromEventCommand command ) throws Exception {
		...
		Assert.notNull( command.getEventId(), "UnAssignTargetsFromEventCommand identifier should not be null" );
	}
	/**
