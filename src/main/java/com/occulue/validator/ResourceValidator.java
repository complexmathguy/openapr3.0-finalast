...
public class ResourceValidator {
	 ...
	 * factory method
	 */
	static public ResourceValidator getInstance() {
...
//		Assert.isNull( resource.getResourceId(), "CreateResourceCommand identifier should be null" );
		Assert.notNull( resource.getCreatedDateTime(), "Field CreateResourceCommand.createdDateTime should not be null" );
		Assert.notNull( resource.getModificationDateTime(), "Field CreateResourceCommand.modificationDateTime should not be null" );
		Assert.notNull( resource.getResourceName(), "Field CreateResourceCommand.resourceName should not be null" );
	}
	...
	public void validate( UpdateResourceCommand resource ) throws Exception {
		...
		Assert.notNull( resource.getCreatedDateTime(), "Field UpdateResourceCommand.createdDateTime should not be null" );
		Assert.notNull( resource.getModificationDateTime(), "Field UpdateResourceCommand.modificationDateTime should not be null" );
		Assert.notNull( resource.getResourceName(), "Field UpdateResourceCommand.resourceName should not be null" );
    }
	...
	public void validate( ResourceFetchOneSummary summary ) throws Exception {
		...
		Assert.notNull( summary.getResourceId(), "ResourceFetchOneSummary identifier should not be null" );
	}
	...
	public void validate( AssignVenToResourceCommand command ) throws Exception {
		...
		Assert.notNull( command.getResourceId(), "AssignVenToResourceCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignVenToResourceCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignVenFromResourceCommand command ) throws Exception {
		...
		Assert.notNull( command.getResourceId(), "UnAssignVenFromResourceCommand identifier should not be null" );
	}
	...
	public void validate( AssignAttributesToResourceCommand command ) throws Exception {
		...
		Assert.notNull( command.getResourceId(), "AssignAttributesToResourceCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignAttributesToResourceCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveAttributesFromResourceCommand command ) throws Exception {
		...
		Assert.notNull( command.getResourceId(), "RemoveAttributesFromResourceCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveAttributesFromResourceCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getValuesMapId(), "RemoveAttributesFromResourceCommand removeFrom attribubte identifier should not be null" );
	}
	...
	public void validate( AssignTargetsToResourceCommand command ) throws Exception {
		...
		Assert.notNull( command.getResourceId(), "AssignTargetsToResourceCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignTargetsToResourceCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveTargetsFromResourceCommand command ) throws Exception {
		...
		Assert.notNull( command.getResourceId(), "RemoveTargetsFromResourceCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveTargetsFromResourceCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getValuesMapId(), "RemoveTargetsFromResourceCommand removeFrom attribubte identifier should not be null" );
	}
