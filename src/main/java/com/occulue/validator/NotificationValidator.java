...
//		Assert.isNull( notification.getNotificationId(), "CreateNotificationCommand identifier should be null" );
	...
	public void validate( AssignTargetsToNotificationCommand command ) throws Exception {
		...
		Assert.notNull( command.getNotificationId(), "AssignTargetsToNotificationCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTargetsToNotificationCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTargetsFromNotificationCommand command ) throws Exception {
		...
		Assert.notNull( command.getNotificationId(), "UnAssignTargetsFromNotificationCommand identifier should not be null" );
	}
	/**
