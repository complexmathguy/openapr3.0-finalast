...
public class IntervalValidator {
	 ...
	 * factory method
	 */
	static public IntervalValidator getInstance() {
...
//		Assert.isNull( interval.getIntervalId(), "CreateIntervalCommand identifier should be null" );
	...
	public void validate( IntervalFetchOneSummary summary ) throws Exception {
		...
		Assert.notNull( summary.getIntervalId(), "IntervalFetchOneSummary identifier should not be null" );
	}
	...
	public void validate( AssignIntervalPeriodToIntervalCommand command ) throws Exception {
		...
		Assert.notNull( command.getIntervalId(), "AssignIntervalPeriodToIntervalCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIntervalPeriodToIntervalCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIntervalPeriodFromIntervalCommand command ) throws Exception {
		...
		Assert.notNull( command.getIntervalId(), "UnAssignIntervalPeriodFromIntervalCommand identifier should not be null" );
	}
	...
	public void validate( AssignPayloadsToIntervalCommand command ) throws Exception {
		...
		Assert.notNull( command.getIntervalId(), "AssignPayloadsToIntervalCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignPayloadsToIntervalCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemovePayloadsFromIntervalCommand command ) throws Exception {
		...
		Assert.notNull( command.getIntervalId(), "RemovePayloadsFromIntervalCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemovePayloadsFromIntervalCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getValuesMapId(), "RemovePayloadsFromIntervalCommand removeFrom attribubte identifier should not be null" );
	}
