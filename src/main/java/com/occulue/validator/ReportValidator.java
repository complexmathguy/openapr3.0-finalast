...
//		Assert.isNull( report.getReportId(), "CreateReportCommand identifier should be null" );
		Assert.notNull( report.getCreatedDateTime(), "Field CreateReportCommand.createdDateTime should not be null" );
		Assert.notNull( report.getModificationDateTime(), "Field CreateReportCommand.modificationDateTime should not be null" );
		Assert.notNull( report.getClientName(), "Field CreateReportCommand.clientName should not be null" );
		Assert.notNull( report.getReportName(), "Field CreateReportCommand.reportName should not be null" );
	}
	...
	public void validate( UpdateReportCommand report ) throws Exception {
		...
		Assert.notNull( report.getCreatedDateTime(), "Field UpdateReportCommand.createdDateTime should not be null" );
		Assert.notNull( report.getModificationDateTime(), "Field UpdateReportCommand.modificationDateTime should not be null" );
		Assert.notNull( report.getClientName(), "Field UpdateReportCommand.clientName should not be null" );
		Assert.notNull( report.getReportName(), "Field UpdateReportCommand.reportName should not be null" );
    }
	...
	public void validate( AssignProgramToReportCommand command ) throws Exception {
		...
		Assert.notNull( command.getReportId(), "AssignProgramToReportCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignProgramToReportCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignProgramFromReportCommand command ) throws Exception {
		...
		Assert.notNull( command.getReportId(), "UnAssignProgramFromReportCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignEventToReportCommand command ) throws Exception {
		...
		Assert.notNull( command.getReportId(), "AssignEventToReportCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignEventToReportCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignEventFromReportCommand command ) throws Exception {
		...
		Assert.notNull( command.getReportId(), "UnAssignEventFromReportCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignIntervalsToReportCommand command ) throws Exception {
		...
		Assert.notNull( command.getReportId(), "AssignIntervalsToReportCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIntervalsToReportCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIntervalsFromReportCommand command ) throws Exception {
		...
		Assert.notNull( command.getReportId(), "UnAssignIntervalsFromReportCommand identifier should not be null" );
	}
	/**
	...
	public void validate( AssignIntervalPeriodToReportCommand command ) throws Exception {
		...
		Assert.notNull( command.getReportId(), "AssignIntervalPeriodToReportCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignIntervalPeriodToReportCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignIntervalPeriodFromReportCommand command ) throws Exception {
		...
		Assert.notNull( command.getReportId(), "UnAssignIntervalPeriodFromReportCommand identifier should not be null" );
	}
	...
	public void validate( AssignPayloadDescriptorsToReportCommand command ) throws Exception {
		...
		Assert.notNull( command.getReportId(), "AssignPayloadDescriptorsToReportCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignPayloadDescriptorsToReportCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemovePayloadDescriptorsFromReportCommand command ) throws Exception {
		...
		Assert.notNull( command.getReportId(), "RemovePayloadDescriptorsFromReportCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemovePayloadDescriptorsFromReportCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getPayloadDescriptorId(), "RemovePayloadDescriptorsFromReportCommand removeFrom attribubte identifier should not be null" );
	}
	...
	public void validate( AssignResourcesToReportCommand command ) throws Exception {
		...
		Assert.notNull( command.getReportId(), "AssignResourcesToReportCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignResourcesToReportCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveResourcesFromReportCommand command ) throws Exception {
		...
		Assert.notNull( command.getReportId(), "RemoveResourcesFromReportCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveResourcesFromReportCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getResourceId(), "RemoveResourcesFromReportCommand removeFrom attribubte identifier should not be null" );
	}
