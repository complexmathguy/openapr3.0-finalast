...
public class VenValidator {
	 ...
	 * factory method
	 */
	static public VenValidator getInstance() {
...
//		Assert.isNull( ven.getVenId(), "CreateVenCommand identifier should be null" );
		Assert.notNull( ven.getCreatedDateTime(), "Field CreateVenCommand.createdDateTime should not be null" );
		Assert.notNull( ven.getModificationDateTime(), "Field CreateVenCommand.modificationDateTime should not be null" );
	...
	public void validate( UpdateVenCommand ven ) throws Exception {
		...
		Assert.notNull( ven.getCreatedDateTime(), "Field UpdateVenCommand.createdDateTime should not be null" );
		Assert.notNull( ven.getModificationDateTime(), "Field UpdateVenCommand.modificationDateTime should not be null" );
	...
	public void validate( AssignAttributesToVenCommand command ) throws Exception {
		...
		Assert.notNull( command.getVenId(), "AssignAttributesToVenCommand identifier should not be null" );
		Assert.notNull( command.getAddTo(), "AssignAttributesToVenCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveAttributesFromVenCommand command ) throws Exception {
		...
		Assert.notNull( command.getVenId(), "RemoveAttributesFromVenCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveAttributesFromVenCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getValuesMapId(), "RemoveAttributesFromVenCommand removeFrom attribubte identifier should not be null" );
	}
	...
	public void validate( AssignTargetsToVenCommand command ) throws Exception {
		...
		Assert.notNull( command.getAddTo(), "AssignTargetsToVenCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveTargetsFromVenCommand command ) throws Exception {
		...
		Assert.notNull( command.getRemoveFrom(), "RemoveTargetsFromVenCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getValuesMapId(), "RemoveTargetsFromVenCommand removeFrom attribubte identifier should not be null" );
	}
	...
	public void validate( AssignResourcesToVenCommand command ) throws Exception {
		...
		Assert.notNull( command.getAddTo(), "AssignResourcesToVenCommand addTo attribute should not be null" );
	}
	...
	public void validate( RemoveResourcesFromVenCommand command ) throws Exception {
		...
		Assert.notNull( command.getVenId(), "RemoveResourcesFromVenCommand identifier should not be null" );
		Assert.notNull( command.getRemoveFrom(), "RemoveResourcesFromVenCommand removeFrom attribute should not be null" );
		Assert.notNull( command.getRemoveFrom().getResourceId(), "RemoveResourcesFromVenCommand removeFrom attribubte identifier should not be null" );
	}
