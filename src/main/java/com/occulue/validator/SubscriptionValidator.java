...
//		Assert.isNull( subscription.getSubscriptionId(), "CreateSubscriptionCommand identifier should be null" );
	...
	public void validate( AssignTargetsToSubscriptionCommand command ) throws Exception {
		...
		Assert.notNull( command.getSubscriptionId(), "AssignTargetsToSubscriptionCommand identifier should not be null" );
		Assert.notNull( command.getAssignment(), "AssignTargetsToSubscriptionCommand assignment should not be null" );
	}
	...
	public void validate( UnAssignTargetsFromSubscriptionCommand command ) throws Exception {
		...
		Assert.notNull( command.getSubscriptionId(), "UnAssignTargetsFromSubscriptionCommand identifier should not be null" );
	}
