...
public class IntervalPeriodAggregate {  
    ...
    public IntervalPeriodAggregate(CreateIntervalPeriodCommand command) throws Exception {
    	...
    	CreateIntervalPeriodEvent event = new CreateIntervalPeriodEvent(command.getIntervalPeriodId(), command.getStart(), command.getDuration(), command.getRandomizeStart());
    ...
    public void handle(UpdateIntervalPeriodCommand command) throws Exception {
    	...
    	UpdateIntervalPeriodEvent event = new UpdateIntervalPeriodEvent(command.getIntervalPeriodId(), command.getStart(), command.getDuration(), command.getRandomizeStart());        
