...
public class VenAggregate {  
    ...
    public VenAggregate(CreateVenCommand command) throws Exception {
    	...
    	CreateVenEvent event = new CreateVenEvent(command.getVenId(), command.getCreatedDateTime(), command.getModificationDateTime(), command.getVenName(), command.getObjectType());
