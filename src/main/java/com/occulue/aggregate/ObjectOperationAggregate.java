...
public class ObjectOperationAggregate {  
    ...
    public ObjectOperationAggregate(CreateObjectOperationCommand command) throws Exception {
    	...
    	CreateObjectOperationEvent event = new CreateObjectOperationEvent(command.getObjectOperationId(), command.getCallbackUrl(), command.getBearerToken(), command.getObjects(), command.getOperations());
