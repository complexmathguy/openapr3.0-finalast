...
public class NotificationAggregate {  
    ...
    public NotificationAggregate(CreateNotificationCommand command) throws Exception {
    	...
    	CreateNotificationEvent event = new CreateNotificationEvent(command.getNotificationId(), command.getObjectType(), command.getOperation());
    ...
    public void handle(AssignTargetsToNotificationCommand command) throws Exception {
        ...
        apply(new AssignTargetsToNotificationEvent(command.getNotificationId(), command.getAssignment()));
    }
