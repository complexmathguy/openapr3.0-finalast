...
public class ValuesMapAggregate {  
    ...
    public ValuesMapAggregate(CreateValuesMapCommand command) throws Exception {
    	...
    	CreateValuesMapEvent event = new CreateValuesMapEvent(command.getValuesMapId(), command.getType(), command.getValues());
    ...
    public void handle(UpdateValuesMapCommand command) throws Exception {
    	...
    	UpdateValuesMapEvent event = new UpdateValuesMapEvent(command.getValuesMapId(), command.getType(), command.getValues());        
