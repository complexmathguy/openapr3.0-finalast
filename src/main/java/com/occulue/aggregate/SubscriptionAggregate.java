...
public class SubscriptionAggregate {  
    ...
    public SubscriptionAggregate(CreateSubscriptionCommand command) throws Exception {
    	...
    	CreateSubscriptionEvent event = new CreateSubscriptionEvent(command.getSubscriptionId(), command.getCreatedDateTime(), command.getModificationDateTime(), command.getClientName(), command.getObjectType());
    ...
    public void handle(AssignTargetsToSubscriptionCommand command) throws Exception {
        ...
        apply(new AssignTargetsToSubscriptionEvent(command.getSubscriptionId(), command.getAssignment()));
    }
