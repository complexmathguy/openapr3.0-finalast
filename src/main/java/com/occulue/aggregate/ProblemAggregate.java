...
public class ProblemAggregate {  
    ...
    public ProblemAggregate(CreateProblemCommand command) throws Exception {
    	...
    	CreateProblemEvent event = new CreateProblemEvent(command.getProblemId(), command.getType(), command.getTitle(), command.getStatus(), command.getDetail(), command.getInstance());
    ...
    public void handle(UpdateProblemCommand command) throws Exception {
    	...
    	UpdateProblemEvent event = new UpdateProblemEvent(command.getProblemId(), command.getType(), command.getTitle(), command.getStatus(), command.getDetail(), command.getInstance());        
