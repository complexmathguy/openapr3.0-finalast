...
public class ReportAggregate {  
    ...
    public ReportAggregate(CreateReportCommand command) throws Exception {
    	...
    	CreateReportEvent event = new CreateReportEvent(command.getReportId(), command.getCreatedDateTime(), command.getModificationDateTime(), command.getClientName(), command.getReportName(), command.getObjectType());
    ...
    public void handle(AssignIntervalsToReportCommand command) throws Exception {
    	...
    	if (  intervals != null && intervals.getIntervalId() == command.getAssignment().getIntervalId() )
    		throw new ProcessingException( "Intervals already assigned with id " + command.getAssignment().getIntervalId() );  
    ...
    public void handle(UnAssignIntervalsFromReportCommand command) throws Exception {
    	...
    	if (  intervals == null )
    		throw new ProcessingException( "Intervals already has nothing assigned." );  
