...
public class EventAggregate {  
    ...
    public EventAggregate(CreateEventCommand command) throws Exception {
    	...
    	CreateEventEvent event = new CreateEventEvent(command.getEventId(), command.getCreatedDateTime(), command.getModificationDateTime(), command.getEventName(), command.getPriority(), command.getObjectType());
