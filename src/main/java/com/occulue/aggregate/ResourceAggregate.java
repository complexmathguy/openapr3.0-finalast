...
public class ResourceAggregate {  
    ...
    public ResourceAggregate(CreateResourceCommand command) throws Exception {
    	...
    	CreateResourceEvent event = new CreateResourceEvent(command.getResourceId(), command.getCreatedDateTime(), command.getModificationDateTime(), command.getResourceName(), command.getObjectType());
