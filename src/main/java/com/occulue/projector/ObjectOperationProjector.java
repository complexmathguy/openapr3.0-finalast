...
/**
 * Projector for ObjectOperation as outlined for the CQRS pattern.  All event handling and query handling related to ObjectOperation are invoked here
 * and dispersed as an event to be handled elsewhere.
 * 
 * Commands are handled by ObjectOperationAggregate
 * 
...
public class ObjectOperationProjector extends ObjectOperationEntityProjector {
	...
	// core constructor
	public ObjectOperationProjector(ObjectOperationRepository repository, QueryUpdateEmitter queryUpdateEmitter ) {
        super(repository);
    ...
    @SuppressWarnings("unused")
    @QueryHandler
    public List<ObjectOperation> handle( FindAllObjectOperationQuery query ) throws ProcessingException {
    	return findAll( query );
    }


	/**
	 * emit to subscription queries of type FindObjectOperation, 
	...
	protected void emitFindObjectOperation( ObjectOperation entity ) {
	    ...
	    queryUpdateEmitter.emit(FindObjectOperationQuery.class,
	...
	protected void emitFindAllObjectOperation( ObjectOperation entity ) {
	    ...
	    queryUpdateEmitter.emit(FindAllObjectOperationQuery.class,
	                            query -> true,
	                            entity);
	}
