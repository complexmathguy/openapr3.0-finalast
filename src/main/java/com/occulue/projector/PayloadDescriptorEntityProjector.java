...
public class PayloadDescriptorEntityProjector {
    ...
    // --------------------------------------------------
	@Autowired
    protected final PayloadDescriptorRepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(PayloadDescriptorEntityProjector.class.getName());
