...
/**
 * Projector for ValuesMap as outlined for the CQRS pattern.  All event handling and query handling related to ValuesMap are invoked here
...
public class ValuesMapProjector extends ValuesMapEntityProjector {
	...
	/**
	 * emit to subscription queries of type FindValuesMap, 
	...
	protected void emitFindValuesMap( ValuesMap entity ) {
	    ...
	    queryUpdateEmitter.emit(FindValuesMapQuery.class,
	...
	protected void emitFindAllValuesMap( ValuesMap entity ) {
	    ...
	    queryUpdateEmitter.emit(FindAllValuesMapQuery.class,
	                            query -> true,
	                            entity);
	}
