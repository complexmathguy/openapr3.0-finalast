...
/**
 * Projector for Problem as outlined for the CQRS pattern.  All event handling and query handling related to Problem are invoked here
 * and dispersed as an event to be handled elsewhere.
 * 
 * Commands are handled by ProblemAggregate
 * 
...
public class ProblemProjector extends ProblemEntityProjector {
	...
	/**
	 * emit to subscription queries of type FindProblem, 
	...
	protected void emitFindProblem( Problem entity ) {
	    ...
	    queryUpdateEmitter.emit(FindProblemQuery.class,
	...
	protected void emitFindAllProblem( Problem entity ) {
	    ...
	    queryUpdateEmitter.emit(FindAllProblemQuery.class,
	                            query -> true,
	                            entity);
	}
