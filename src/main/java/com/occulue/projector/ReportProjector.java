...
/**
 * Projector for Report as outlined for the CQRS pattern.  All event handling and query handling related to Report are invoked here
 * and dispersed as an event to be handled elsewhere.
 * 
 * Commands are handled by ReportAggregate
 * 
