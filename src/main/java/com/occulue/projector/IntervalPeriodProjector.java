...
/**
 * Projector for IntervalPeriod as outlined for the CQRS pattern.  All event handling and query handling related to IntervalPeriod are invoked here
 * and dispersed as an event to be handled elsewhere.
 * 
 * Commands are handled by IntervalPeriodAggregate
 * 
...
public class IntervalPeriodProjector extends IntervalPeriodEntityProjector {
	...
	// core constructor
	public IntervalPeriodProjector(IntervalPeriodRepository repository, QueryUpdateEmitter queryUpdateEmitter ) {
        super(repository);
	...
	/**
	 * emit to subscription queries of type FindIntervalPeriod, 
	...
	protected void emitFindIntervalPeriod( IntervalPeriod entity ) {
	    ...
	    queryUpdateEmitter.emit(FindIntervalPeriodQuery.class,
	...
	protected void emitFindAllIntervalPeriod( IntervalPeriod entity ) {
	    ...
	    queryUpdateEmitter.emit(FindAllIntervalPeriodQuery.class,
	                            query -> true,
	                            entity);
	}
