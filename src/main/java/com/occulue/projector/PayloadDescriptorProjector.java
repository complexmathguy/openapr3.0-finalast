...
/**
 * Projector for PayloadDescriptor as outlined for the CQRS pattern.  All event handling and query handling related to PayloadDescriptor are invoked here
 * and dispersed as an event to be handled elsewhere.
 * 
 * Commands are handled by PayloadDescriptorAggregate
 * 
...
public class PayloadDescriptorProjector extends PayloadDescriptorEntityProjector {
	...
	// core constructor
	public PayloadDescriptorProjector(PayloadDescriptorRepository repository, QueryUpdateEmitter queryUpdateEmitter ) {
        super(repository);
    ...
    @SuppressWarnings("unused")
    @QueryHandler
    public List<PayloadDescriptor> handle( FindAllPayloadDescriptorQuery query ) throws ProcessingException {
    	return findAll( query );
    }


	/**
	 * emit to subscription queries of type FindPayloadDescriptor, 
	...
	protected void emitFindPayloadDescriptor( PayloadDescriptor entity ) {
	    ...
	    queryUpdateEmitter.emit(FindPayloadDescriptorQuery.class,
	...
	protected void emitFindAllPayloadDescriptor( PayloadDescriptor entity ) {
	    ...
	    queryUpdateEmitter.emit(FindAllPayloadDescriptorQuery.class,
	                            query -> true,
	                            entity);
	}
