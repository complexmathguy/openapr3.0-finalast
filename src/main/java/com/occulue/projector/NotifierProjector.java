...
/**
 * Projector for Notifier as outlined for the CQRS pattern.  All event handling and query handling related to Notifier are invoked here
 * and dispersed as an event to be handled elsewhere.
 * 
 * Commands are handled by NotifierAggregate
 * 
...
public class NotifierProjector extends NotifierEntityProjector {
	...
	/**
	 * emit to subscription queries of type FindNotifier, 
	...
	protected void emitFindNotifier( Notifier entity ) {
	    ...
	    queryUpdateEmitter.emit(FindNotifierQuery.class,
	...
	protected void emitFindAllNotifier( Notifier entity ) {
	    ...
	    queryUpdateEmitter.emit(FindAllNotifierQuery.class,
	                            query -> true,
	                            entity);
	}
