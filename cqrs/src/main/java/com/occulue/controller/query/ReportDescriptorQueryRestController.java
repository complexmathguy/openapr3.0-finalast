...
public class ReportDescriptorQueryRestController extends BaseSpringRestController {
    ...
    public ReportDescriptor load( @RequestParam(required=true) UUID reportDescriptorId ) {
    	...
    	try {  
    		entity = ReportDescriptorBusinessDelegate.getReportDescriptorInstance().getReportDescriptor( new ReportDescriptorFetchOneSummary( reportDescriptorId ) );
        }
        catch( Throwable exc ) {
    ...
    public List<ReportDescriptor> loadAll() {                
    	...
    	try {
            ...
            reportDescriptorList = ReportDescriptorBusinessDelegate.getReportDescriptorInstance().getAllReportDescriptor();
...
//************************************************************************
    ...
    private static final Logger LOGGER = Logger.getLogger(ReportDescriptorQueryRestController.class.getName());
