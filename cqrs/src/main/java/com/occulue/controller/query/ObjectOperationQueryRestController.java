...
public class ObjectOperationQueryRestController extends BaseSpringRestController {
    ...
    public ObjectOperation load( @RequestParam(required=true) UUID objectOperationId ) {
    	...
    	try {  
    		entity = ObjectOperationBusinessDelegate.getObjectOperationInstance().getObjectOperation( new ObjectOperationFetchOneSummary( objectOperationId ) );
        }
        catch( Throwable exc ) {
    ...
    public List<ObjectOperation> loadAll() {                
    	...
    	try {
            ...
            objectOperationList = ObjectOperationBusinessDelegate.getObjectOperationInstance().getAllObjectOperation();
...
//************************************************************************
    ...
    private static final Logger LOGGER = Logger.getLogger(ObjectOperationQueryRestController.class.getName());
