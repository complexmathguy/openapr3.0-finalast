...
public class PayloadDescriptorQueryRestController extends BaseSpringRestController {
    ...
    public PayloadDescriptor load( @RequestParam(required=true) UUID payloadDescriptorId ) {
    	...
    	try {  
    		entity = PayloadDescriptorBusinessDelegate.getPayloadDescriptorInstance().getPayloadDescriptor( new PayloadDescriptorFetchOneSummary( payloadDescriptorId ) );
        }
        catch( Throwable exc ) {
    ...
    public List<PayloadDescriptor> loadAll() {                
    	...
    	try {
            ...
            payloadDescriptorList = PayloadDescriptorBusinessDelegate.getPayloadDescriptorInstance().getAllPayloadDescriptor();
...
//************************************************************************
    ...
    private static final Logger LOGGER = Logger.getLogger(PayloadDescriptorQueryRestController.class.getName());
