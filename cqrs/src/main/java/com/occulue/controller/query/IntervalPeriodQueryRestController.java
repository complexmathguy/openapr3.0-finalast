...
public class IntervalPeriodQueryRestController extends BaseSpringRestController {
    ...
    public IntervalPeriod load( @RequestParam(required=true) UUID intervalPeriodId ) {
    	...
    	try {  
    		entity = IntervalPeriodBusinessDelegate.getIntervalPeriodInstance().getIntervalPeriod( new IntervalPeriodFetchOneSummary( intervalPeriodId ) );
        }
        catch( Throwable exc ) {
    ...
    public List<IntervalPeriod> loadAll() {                
    	...
    	try {
            ...
            intervalPeriodList = IntervalPeriodBusinessDelegate.getIntervalPeriodInstance().getAllIntervalPeriod();
...
//************************************************************************
    ...
    private static final Logger LOGGER = Logger.getLogger(IntervalPeriodQueryRestController.class.getName());
