...
public class ProgramCommandRestController extends BaseSpringRestController {
     ...
     */
	@PostMapping("/create")
    public CompletableFuture<UUID> create( @RequestBody(required=true) CreateProgramCommand command ) {
     ...
     */
	@PutMapping("/update")
    public CompletableFuture<Void> update( @RequestBody(required=true) UpdateProgramCommand command ) {
		...
		try {                        	        
	    	...
	    	LOGGER.log( Level.WARNING, "ProgramController:update() - successfully update Program - " + exc.getMessage());        	
	    }		
	...
	public void unAssignIntervalPeriod( @RequestBody(required=true)  UnAssignIntervalPeriodFromProgramCommand command ) {
		try {
	...
	public void addToPayloadDescriptors( @RequestBody(required=true) AssignPayloadDescriptorsToProgramCommand command ) {
		try {
	...
	public void removeFromPayloadDescriptors( 	@RequestBody(required=true) RemovePayloadDescriptorsFromProgramCommand command )
	{		
		try {
	...
	public void removeFromTargets( 	@RequestBody(required=true) RemoveTargetsFromProgramCommand command )
	{		
		try {
...
//************************************************************************
    ...
    private static final Logger LOGGER = Logger.getLogger(ProgramCommandRestController.class.getName());
