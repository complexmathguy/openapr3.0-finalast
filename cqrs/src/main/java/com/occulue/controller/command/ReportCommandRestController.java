...
public class ReportCommandRestController extends BaseSpringRestController {
	...
	public void unAssignProgram( @RequestBody(required=true)  UnAssignProgramFromReportCommand command ) {
		try {
	...
	public void unAssignIntervals( @RequestBody(required=true)  UnAssignIntervalsFromReportCommand command ) {
		try {
	...
	public void unAssignIntervalPeriod( @RequestBody(required=true)  UnAssignIntervalPeriodFromReportCommand command ) {
		try {
	...
	public void addToPayloadDescriptors( @RequestBody(required=true) AssignPayloadDescriptorsToReportCommand command ) {
		try {
	...
	public void removeFromPayloadDescriptors( 	@RequestBody(required=true) RemovePayloadDescriptorsFromReportCommand command )
	{		
		try {
	...
	public void removeFromResources( 	@RequestBody(required=true) RemoveResourcesFromReportCommand command )
	{		
		try {
